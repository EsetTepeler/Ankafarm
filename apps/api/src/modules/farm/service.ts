import { DEFAULT_GROUP_NAME, seedBreeds, seedObservationTags } from "@anka/shared";

import type { Db } from "../../db/client";
import { breeds, groups, observationTags } from "../../db/schema";

type Tx = Parameters<Parameters<Db["transaction"]>[0]>[0];

/** Yeni çiftlik: yaygın ırklar ve "Ana sürü" grubu tohumlanır. */
